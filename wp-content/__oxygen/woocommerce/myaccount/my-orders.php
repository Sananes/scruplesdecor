...
if ( $customer_orders ) : ?>
	...
	<h4 class="with-divider"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h4>
...
<?php else: ?>
	...
	<p class="muted"><?php _e('You have no recent orders yet!', 'oxygen'); ?></p>
