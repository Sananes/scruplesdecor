...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
		<a href="?page=<?php echo get('page'); ?>&tab=main" class="nav-tab<?php echo $current_tab == 'main' ? ' nav-tab-active' : ''; ?>">General Style</a>
		<a href="?page=<?php echo get('page'); ?>&tab=responsive" class="nav-tab<?php echo $current_tab == 'responsive' ? ' nav-tab-active' : ''; ?>">Responsive</a>
		<a href="?page=<?php echo get('page'); ?>&tab=less" class="nav-tab<?php echo $current_tab == 'less' ? ' nav-tab-active' : ''; ?>">LESS</a>
		<a href="?page=<?php echo get('page'); ?>&tab=sass" class="nav-tab<?php echo $current_tab == 'sass' ? ' nav-tab-active' : ''; ?>">SASS</a>
...
function laborator_get_custom_css($ex = '')
{
	...
	return stripslashes(get_option('laborator_custom_css' . ($ex ? "_{$ex}" : ''), $default));
}
...
function lab_custom_css_admin_print_styles()
{
	...
	#toplevel_page_laborator_custom_css:hover .wp-menu-image, #toplevel_page_laborator_custom_css.wp-has-current-submenu .wp-menu-image {
