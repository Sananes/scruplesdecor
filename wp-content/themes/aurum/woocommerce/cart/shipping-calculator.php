...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2><a href="#" class="shipping-calculator-button btn btn-gray btn-block"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>
	...
	<section class="shipping-calculator-form">
		...
		<p class="form-row form-row-wide">
			<?php
				...
				if ( is_array( $states ) && empty( $states ) ) {
					...
					?><input type="hidden" name="calc_shipping_state" id="calc_shipping_state" class="form-control" placeholder="<?php _e( 'State / county', 'woocommerce' ); ?>" /><?php
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button btn btn-primary btn-lg btn-block"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
