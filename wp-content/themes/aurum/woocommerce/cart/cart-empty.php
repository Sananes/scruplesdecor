...
?>
<div class="shop-empty-cart-page">
			...
			<div class="cart-empty-title">
				...
				<p class="return-to-shop">
					<a class="button wc-backward" href="<?php echo apply_filters( 'woocommerce_return_to_shop_redirect', get_permalink( wc_get_page_id( 'shop' ) ) ); ?>">
						<?php _e( 'Browse our products &amp; fill the cart!', TD ) ?>
					</a>
				</p>
			</div>
...
<p class="return-to-shop"><a class="button wc-backward" href="<?php echo apply_filters( 'woocommerce_return_to_shop_redirect', get_permalink( wc_get_page_id( 'shop' ) ) ); ?>"><?php _e( 'Browse our products &amp; fill the cart!', 'woocommerce' ) ?></a></p>