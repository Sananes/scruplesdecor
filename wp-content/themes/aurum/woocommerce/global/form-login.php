...
<div class="login-form-env"<?php if ( $hidden ) echo ' style="display:none;"'; ?>>
	<div class="bordered-block">
		<h2><?php echo _e('Log in', 'woocommerce'); ?></h2>
		...
		<form method="post" class="login">
			...
			<p class="form-row form-row-first form-group">
				<input type="text" class="input-text form-control" name="username" id="username" placeholder="<?php _e( 'Username or email', 'woocommerce' ); ?>" />
			</p>
