...
<div class="page-title">
	<h2>
		<?php _e('Downloads<small>Available downloads for your account</small>', TD); ?>
	</h2>
</div>
<?php
...
<?php else: ?>
	<h4 class="no-entries"><?php _e("You don't have any downloadable product in your account", TD); ?></h4>
<?php endif; ?>