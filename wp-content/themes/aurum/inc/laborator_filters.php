...
function shortcode_lab_social_networks($atts = array(), $content = '')
{
	...
	$social_order_list = array(
		"fb"  => array("title" => __("Facebook", TD), 		"icon" => "entypo-facebook"),
		"tw"  => array("title" => __("Twitter", TD), 		"icon" => "entypo-twitter"),
		"lin" => array("title" => __("LinkedIn", TD), 		"icon" => "entypo-linkedin"),
		"yt"  => array("title" => __("YouTube", TD), 		"icon" => "entypo-play"),
		"vm"  => array("title" => __("Vimeo", TD), 			"icon" => "entypo-vimeo"),
		"drb" => array("title" => __("Dribbble", TD), 		"icon" => "entypo-dribbble"),
		"ig"  => array("title" => __("Instagram", TD), 		"icon" => "entypo-instagram"),
		"pi"  => array("title" => __("Pinterest", TD), 		"icon" => "entypo-pinterest"),
		"gp"  => array("title" => __("Google+", TD), 		"icon" => "entypo-gplus"),
		"vk"  => array("title" => __("VKontakte", TD), 		"icon" => "entypo-vkontakte"),
	);
	...
	<div <?php comment_class(implode(' ', $comment_classes)); ?> id="comment-<?php echo $comment_ID; ?>"<?php echo $depth > 1 ? " data-replied-to=\"comment-{$comment_parent_ID}\"" : ''; ?>>
		...
		<h4>
			...
			<small>
				...
				<span<?php echo $depth <= 4 ? ' class="visible-xs-inline visible-sm-inline"' : ''; ?>>&ndash; <?php echo sprintf(__('In reply to: <span class="replied-to">%s</span>', TD), $parent_comment->comment_author); ?></span>
				<?php endif; ?>
			</small>
		</h4>
		...
		<?php
			comment_reply_link(
				array_merge(
					$args,
					array(
						'reply_text' => __('<span>Reply</span>', TD),
						'depth' => $depth,
