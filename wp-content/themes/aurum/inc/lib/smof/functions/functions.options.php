...
if(is_admin()):
	...
	$menus_and_widgets["wpml_currency_switcher"]       = "[Widget] Currency Switcher";
...
$of_options[] = array( 	"name" 		=> "Product Columns",
						...
						"std" 		=> "decide",
						"type" 		=> "select",
						"options" 	=> array("six" => "6 columns", "four" => "4 columns", "three" => "3 columns", "two" => "2 columns", "decide" => "Decide when sidebar is present")
				);
