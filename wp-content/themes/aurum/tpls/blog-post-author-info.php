	...
	<div class="author-post">
		...
		<div class="author-description">
			<span class="author-name">
				<?php echo sprintf(__("About the author: %s", TD), $author_link); ?>
			</span>

			<p class="author-about">
				<?php echo $authordata->description ? nl2br($authordata->description) : __('No other information about this author.', TD); ?>
			</p>
		</div>
	</div>
	<?php
