...
<div id="shortcode-generator">
	...
	<div class="shortcode-content">
		...
		<div class="content"><select id="thb-shortcodes" data-placeholder="' . __("Choose a shortcode") .'">
	    <option></option>';
...
<script src="<?php echo THB_THEME_ROOT; ?>/inc/tinymce/shortcode_generator/js/popup.js"></script>
...
<?php echo $shortcode_html . $html_options;  ?>
	...
	<a class="btn" id="add-shortcode"><?php echo __( 'Add Shortcode' ); ?></a>
