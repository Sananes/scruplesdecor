...
<aside class="sidebar four columns<?php if ($sidebar_pos == 'left') { echo ' pull-eight'; }?><?php if (is_page_template('template-portfolio.php') || is_page_template('template-portfolio-paginated.php')) { echo ' no-border'; } ?>">
	<?php 
