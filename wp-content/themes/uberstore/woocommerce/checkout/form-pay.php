...
<form id="order_review" method="post">
	...
	<table class="shopping_bag order_table">
		<thead>
			<tr>
				...
				<th class="product-subtotal"><?php _e( 'Totals', THB_THEME_NAME ); ?></th>
			</tr>
		</thead>
		<tfoot>
		<?php
	...
	<div id="payment">
		...
		<ul class="payment_methods methods">
			<?php
				if ( $available_gateways = WC()->payment_gateways->get_available_payment_gateways() ) {
					...
					echo '<p>' . __( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', THB_THEME_NAME ) . '</p>';
		...
		<div class="form-row">
			...
			<?php
				$pay_order_button_text = apply_filters( 'woocommerce_pay_order_button_text', __( 'Pay for order', THB_THEME_NAME ) );
