...
if ( $count > 0 ) : ?>
	...
	<div class="woocommerce-product-rating" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
		...
		<a href="#reviews" class="woocommerce-review-link" rel="nofollow">(<?php printf( _n( '%s customer review', '%s customer reviews', $count, THB_THEME_NAME ), '<span itemprop="ratingCount" class="count">' . $count . '</span>' ); ?>)</a>
	</div>
