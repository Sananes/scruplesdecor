...
?>
<div class="largetitle"><?php _e( 'Order Details', THB_THEME_NAME ); ?></div>
<table class="shopping_bag order_table">
	<thead>
		<tr>
			<th class="product-name"><?php _e( 'Product', THB_THEME_NAME ); ?></th>
			<th class="product-total"><?php _e( 'Total', THB_THEME_NAME ); ?></th>
		</tr>
	</thead>
	<tfoot>
	<?php
...
<div class="largetitle"><?php _e( 'Customer details', THB_THEME_NAME ); ?></div>


<?php
	if ( $order->billing_email ) echo '<label>' . __( 'Email:', THB_THEME_NAME ) . '</label><p>' . $order->billing_email . '</p>';
	if ( $order->billing_phone ) echo '<label>' . __( 'Telephone:', THB_THEME_NAME ) . '</label><p>' . $order->billing_phone . '</p>';
...
<?php endif; ?>
		...
		<div class="title">
			<?php _e( 'Billing Address', THB_THEME_NAME ); ?>
		</div>
		<address><p>
			<?php
...
<?php if ( get_option( 'woocommerce_ship_to_billing_address_only' ) === 'no' && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
	...
	<div class="six columns">
		...
		<div class="title">
			<?php _e( 'Shipping Address', THB_THEME_NAME ); ?>
		</div>
		<address><p>
			<?php
