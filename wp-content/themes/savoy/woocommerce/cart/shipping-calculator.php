...
<a href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?><i class="nm-font nm-font-media-play rotate-90"></i></a>

<div class="shipping-calculator-form" style="display:none;">
    <div class="col-td col-sm-push-6 col-sm-6 col-xs-push-0 col-xs-12">
