...
?>
<li class="shipping">
    <div class="col-th col-sm-6 col-xs-12">
        <?php
    ...
    <div class="col-td col-sm-6 col-xs-12">
        <?php if ( ! empty( $available_methods ) ) : ?>
            ...
            <?php else : ?>
                ...
                <ul id="shipping_method">
                    <?php foreach ( $available_methods as $method ) : ?>
                        <li>
                            <input type="radio" name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo $index; ?>" id="shipping_method_<?php echo $index; ?>_<?php echo sanitize_title( $method->id ); ?>" value="<?php echo esc_attr( $method->id ); ?>" <?php checked( $method->id, $chosen_method ); ?> class="shipping_method nm-custom-radio" />
                            <label for="shipping_method_<?php echo $index; ?>_<?php echo sanitize_title( $method->id ); ?>" class="nm-custom-radio-label"><?php echo wp_kses_post( wc_cart_totals_shipping_method_label( $method ) ); ?></label>
                        </li>
                    <?php endforeach; ?>
                </ul>
...
<?php if ( is_cart() ) : ?>
<li class="shipping-calculator-wrap">
