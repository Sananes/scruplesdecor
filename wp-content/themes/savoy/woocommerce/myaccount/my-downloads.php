		...
		<?php foreach ( $downloads as $download ) : ?>
			<li>
				<?php
					...
					echo apply_filters( 'woocommerce_available_download_link', '<a href="' . esc_url( $download['download_url'] ) . '"><i class="nm-font nm-font-media-play rotate-90"></i> ' . $download['download_name'] . '</a>', $download );
