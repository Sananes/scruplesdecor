...
function pmwi_admin_notices() {
	...
	if ( class_exists( 'PMXI_Plugin' ) and ( version_compare(PMXI_VERSION, '4.0.0') < 0 and PMXI_EDITION == 'paid' or version_compare(PMXI_VERSION, '3.1.3') <= 0 and PMXI_EDITION == 'free') ) {
		?>
		<div class="error"><p>
			<?php printf(
