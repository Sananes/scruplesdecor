...
class Settings_Renderer {
	...
	*/
	 ...
	 * @return string
	 */
	protected function get_plugin_settings_menu_permission() {
	...
	public function add_settings_page() {
	    ...
	    $this->page_title(),
	    $this->menu_title(),
			$this->get_plugin_settings_menu_permission(),
			$this->menu_slug(),
   ...
   */
	...
	public function render_checkbox($args) {
		 ...
		 */
		echo $this->get_input_html('hidden', $field_id . '_unticked', 0, array(), $field_name);
