...
<div class="vc_controls vc_controls-row controls vc_clearfix vc_param_group-controls">
	...
	<span class="vc_row_edit_clone_delete">
		<a class="vc_control column_delete vc_delete-param" href="#" title="' . __( 'Delete this param', 'js_composer' ) . '"><i class="vc_icon"></i></a>
		<a class="vc_control column_clone" href="#" title="' . __( 'Clone this row', 'js_composer' ) . '"><i class="vc_icon"></i></a>
		<a class="vc_control column_toggle" href="#" title="' . __( 'Toggle row', 'js_composer' ) . '"><i class="vc_icon"></i></a>
	</span>
</div>
