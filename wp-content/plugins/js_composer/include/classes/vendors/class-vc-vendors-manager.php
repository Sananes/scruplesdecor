...
class Vc_Vendors_Manager {
	...
	function __construct() {
		_deprecated_function( 'Vc_Vendors_Manager::__construct', '4.4', 'autoload logic' );
	...
	public function init() {
		_deprecated_function( 'Vc_Vendors_Manager::init', '4.4', 'autoload logic' );
	...
	public function add( Vc_Vendor_Interface $vendor ) {
		_deprecated_function( 'Vc_Vendors_Manager::add', '4.4', 'autoload logic' );
