...
class WAS_Condition {
	 ...
	 * @since 1.0.0
	 */
	public function was_create_object() {

		?><div class='was-condition-wrap'><?php

			do_action( 'was_before_condition', $this );

			$this->was_condition_conditions();
			$this->was_condition_operator();
			$this->was_condition_values();

			$this->was_add_condition_button();
			$this->was_remove_condition_button();

			$this->was_condition_description();

			do_action( 'was_after_condition', $this );
	 ...
	 * @since 1.0.0
	 */
	public function was_condition_conditions() {

		was_condition_conditions( $this->id, $this->group, $this->condition );
	 ...
	 * @since 1.0.0
	 */
	public function was_condition_operator() {

		was_condition_operator( $this->id, $this->group, $this->operator );
	 ...
	 * @since 1.0.0
	 */
	public function was_add_condition_button() {
		?>
	 ...
	 * @since 1.0.0
	 */
	public function was_remove_condition_button() {
		?>
