<div id="bookings_persons" class="woocommerce_options_panel panel wc-metaboxes-wrapper">
	...
	<div class="options_group" id="persons-options">
		...
		<?php woocommerce_wp_text_input( array( 'id' => '_wc_booking_max_persons_group', 'label' => __( 'Max persons', 'woocommerce-bookings' ), 'description' => __( 'The maximum number of persons per booking.', 'woocommerce-bookings' ), 'value' => get_post_meta( $post_id, '_wc_booking_max_persons_group', true ), 'desc_tip' => true, 'type' => 'number', 'custom_attributes' => array(
			'min'   => '',
			'step' 	=> '1'
		) ) ); ?>

		<?php woocommerce_wp_checkbox( array( 'id' => '_wc_booking_person_cost_multiplier', 'label' => __( 'Multiply all costs by person count', 'woocommerce-bookings' ), 'description' => __( 'Enable this to multiply the entire cost of the booking (block and base costs) by the person count.', 'woocommerce-bookings' ), 'desc_tip' => true, 'value' => get_post_meta( $post_id, '_wc_booking_person_cost_multiplier', true ) ) ); ?>
