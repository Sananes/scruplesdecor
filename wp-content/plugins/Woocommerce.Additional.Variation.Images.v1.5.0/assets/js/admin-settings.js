				...
				mediaFrame.on( 'select', function() {
					...
					selection.map( function( attachment ) {
						...
						if ( attachment.id ) {
							...
							// 23 compat check
							if ( wc_additional_variation_images_local.is23 ) {
								...
								thumbs.append( '<li><a href="#" class="wc-additional-variations-images-thumb" data-id="' + attachment.id + '"><img src="' + url + '" width="40" height="40" /><span class="overlay"></span></a></li>' );
							}
						}
					});
